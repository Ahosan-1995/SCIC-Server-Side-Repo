...
async function run() {
    try {
        ...
        const userCollection = client.db('Product-Bazzar').collection('users');
        const productCollection = client.db('Product-Bazzar').collection('products');
...
app.get('/', (req, res) => {
    res.send('Product-Bazzar is on the way!')
})
